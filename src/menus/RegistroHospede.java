...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		header1.setBackground(SystemColor.text);
		header1.setOpaque(false);
		header1.setBounds(0, 0, 910, 36);
		...
		imageFundo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/img/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/img/Ha-100px.png")));
	}
	 ...
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		private void salvarHospede() {
			...
			if (txtDataN.getDate() != null && !txtNome.equals("") && !txtSobrenome.equals("") && !txtTelefone.equals("")) {
				...
				Hospedes hospedes = new Hospedes(txtNome.getText(),
