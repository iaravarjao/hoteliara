...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/aH-150px.png")));
		...
		labelRegistro = new JLabel("Registro de Hóspedes");
	    ...
	    JLabel lblTituloPrincipal = new JLabel("Sistema de reservas Hotel Iara");
	    ...
	    String textoDescripcion = "<html><body>Sistema de reservas de hotéis. Controle e gerencie de forma otimizada e fácil <br> o fluxo hóspedes do hotel   </body></html>";
	    ...
	    String textoDescricao1 = "<html><body> Esta ferramenta permitirá que você mantenha um controle completo e detalhado de seus hóspedes.";
